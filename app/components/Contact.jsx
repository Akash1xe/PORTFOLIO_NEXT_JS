...
<textarea rows="6" placeholder='Enter your message' required className='w-full p-4 outline-none border-[0.59px] border-gray-400 rounded-md bg-white mb-6' name='message'></textarea>
